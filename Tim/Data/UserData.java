	...
	public void save() {
		try (Connection con = Tim.db.pool.getConnection(3000)) {
			PreparedStatement s = con.prepareStatement(
				"REPLACE INTO `users` (`id`, `authed_user`, `total_sprint_wordcount`, `total_sprints`, `total_sprint_duration`, `raptor_adopted`, "
				+ "`raptor_name`, `raptor_favorite_color`, `raptor_bunnies_stolen`, `last_bunny_raid`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
