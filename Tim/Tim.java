...
public class Tim extends PircBot
{
	...
	private static String[] fridgeColours = { "avocado green", "powder blue",
			...
			"orangeish yellow", "neon pink", "topaz", "tope", "silver",
	...
	private static String[] eightballResponses = {
			...
			"You're joking!", "What even is that?", "Penguins", "Ninjas",
			"Zombies", "Pirates", "Robots", "Throw a fridge at something",
			"The power of Baty compels you!", "Christ Baty wills it." };
	...
	private static String[] commandments = {
			...
			"2. Thou shalt daily offer up at least 1,667 words to the altar of Christ Baty.",
