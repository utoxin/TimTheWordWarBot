...
public class Tim extends PircBot
{
			...
			String message)
	{
		...
		if (prefix.equals("!"))
		{
			 ...
			 * else if (command.equals("restarttimer")) { if
			 * (sender.equals("Utoxin") || sender.equals("Sue___b")) {
			 * ticker.cancel(); ticker = null; ticker = new Timer(true);
	...
	private void throwFridge(String channel, String sender, String[] args)
	{
		...
		int time = 5 + this.rand.nextInt(15);
		time *= 1000;
