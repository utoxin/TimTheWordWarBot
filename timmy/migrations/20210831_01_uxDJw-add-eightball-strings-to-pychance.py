"""
add 'eightball' strings to pychance
"""
import uuid
...
__depends__ = {'20210824_03_gwZFe-add-flavor-strings-to-pychance'}


def migrate_tables(conn: Connection):
    fetch_items_sql = "SELECT id, string FROM `eightballs`"
    ...
    with conn.cursor() as cursor:
        ...
        cursor.execute(insert_list_sql, (list_uuid, "eightball_answer"))
