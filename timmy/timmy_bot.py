...
if __name__ == "__main__":
    ...
    if len(config.sections()) == 0:
        ...
        print(
                "No config db_access found. Template file created as botconfig.ini. If the default values don't "
    ...
    yoyo_backend = get_backend(
            'mysql://' + config.get("DB", "user") + ':' + config.get("DB", "password") + '@'
